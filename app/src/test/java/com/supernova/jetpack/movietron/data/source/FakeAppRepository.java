...
public class FakeAppRepository implements AppDataSource {
    ...
    public FakeAppRepository(@Nullable LocalRepository localRepository, @NonNull RemoteRepository remoteRepository, AppExecutors appExecutors) {
        this.localRepository = localRepository;
        this.remoteRepository = remoteRepository;
        this.appExecutors = appExecutors;
    }

    public static FakeAppRepository getInstance(LocalRepository localRepository, RemoteRepository remoteRepository, AppExecutors appExecutors) {
        if (INSTANCE == null) {
            synchronized (FakeAppRepository.class) {
                if (INSTANCE == null) {
                    INSTANCE = new FakeAppRepository(localRepository, remoteRepository, appExecutors);
                }
            }
        }
        return INSTANCE;
